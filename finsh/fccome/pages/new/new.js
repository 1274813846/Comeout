...
Page({
  data: {
    ...
    modalHidden: true,
    arrowr:"../../images/arrow-r-0.png",
    arrowd:"../../images/arrow-d-0.png"
  },
  ...
  createTask: function () {
    ...
    wx.request({
        url: 'https://wushan.mynatapp.cc/ComeOut/task',
      data: {
        name: task.name,
      ...
      success: function(res){
        ...
        wx.navigateTo({
            url: '/pages/new/success/success?command=' + command + '&avatarUrl=' + avatarUrl + '&nickName=' + nickName,
          success: function(res){
            // success
          },
          fail: function() {
